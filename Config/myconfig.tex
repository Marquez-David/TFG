...
\newcommand{\mybooktitlespanish}{Análisis y comparación de paquetes para el desarrollo de web scraping}
...
\newcommand{\mydepositdateEnglish}{X X\textsuperscript{st}, 2022} 

% For RR, mydefensedate is date to be shown in the cover
\newcommand{\mydefensedate}{10 de Junio de 20122}
...
\newcommand{\mybookkeywords}{Web scraping, parser, heuristic, package, evaluation} % (up to a maximum of five)
\newcommand{\mybookpalabrasclave}{Minado Web, analizador, heurística, paquete, evaluación} % (máximo de cinco)
