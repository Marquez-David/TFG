...
\newcommand{\mybooktitle}{Análisis de datos en redes sociales: Caso de estudio aplicado en Twitter}
\newcommand{\mybookauthor}{David Márrquez Mínguez}
\newcommand{\mybookdepartment}{Departamento de Ciencias de la Computación}
\newcommand{\mybookdepartmentEnglish}{Departament of Computer Science}
...
\newcommand{\mybookauthordegree}{Ingeniero Informático} \newcommand{\mybookemail}{david.marquez@edu.uah.es}
\newcommand{\mybookNameFirstAdvisor}{Juan José Cuadrado Gallego}
...
\newcommand{\myanteproyectodate}{27 de noviembre de 2020}
\newcommand{\mydefensedate}{X de X de 2021}
\newcommand{\mydefensedateEnglish}{X X\textsuperscript{th}, 2021}
\newcommand{\mybookkeywords}{Data analisys, Twitter} \newcommand{\mybookpalabrasclave}{Analisis de datos, Twitter} 
\newcommand{\mybookdepartmentsecretary}{José Luis Martín Sánchez}
\newcommand{\mybookdateforpaperwork}{30 de septiembre de 2014}
\newcommand{\mybookDNIOpenPublishing}{47319570Z-Z}                                 \newcommand{\mybookDNIFirstAdvisor}{11111111-A}
