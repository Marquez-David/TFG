...
\title{FORMULARIO PARA PETICIÓN DE EXPEDICIÓN DE ACTA TFG}        % DO NOT TOUCH THIS LINE
...
\begin{Large}
  ...
  \vspace{0.5cm}
   ...
   \center{EL TUTOR DEL TRABAJO FIN DE GRADO}

    \vspace{1.5cm}
    \center{Fdo.: \mybookNameAcademicTutor}
